...
const starRatings = [
  { className: "star selected", title: "ضعیف", dataValue: 1 },
  { className: "star selected", title: "متوسط", dataValue: 2 },
  { className: "star selected", title: "خوب", dataValue: 3 },
  { className: "star", title: "عالی", dataValue: 4 },
  { className: "star", title: "فوق‌العاده!!!", dataValue: 5 },
];
  ...
  return (
    <div className="section-full content-inner bg-white">
      ...
      <div className="container woo-entry">
          ...
          <div className="col-md-7 col-lg-7 col-sm-12">
            ...
            >
              <div className="dlab-post-title">
                ...
                <p className="m-b10">
                  این محصول با بهترین متریال و کیفیت ساخته شده و برای استفاده
                  روزمره طراحی شده است. طراحی مدرن و راحتی استفاده از
                  ویژگی‌های اصلی این محصول به شمار می‌رود که آن را از سایر
                  محصولات مشابه متمایز می‌کند.
                </p>
              ...
              <div className="relative">
                <h3 className="m-tb10">{formatToman(4280)}</h3>
                <div className="shop-item-rating">
                  ...
                  <span>امتیاز {toPersianDigits("4.5")}</span>
                </div>
              </div>
              ...
              <button className="site-button radius-no">
                <i className="ti-shopping-cart" /> افزودن به سبد خرید
              </button>
            </form>
          </div>
        </div>
            ...
            <div className="dlab-tabs product-description tabs-site-button">
              <ul className="nav nav-tabs">
                <li>
                  <a
                    ...
                    className="active"
                  >
                    <i className="fas fa-globe" /> توضیحات
                  </a>
                </li>
                <li>
                  <a data-bs-toggle="tab" href="#graphic-design-1">
                    <i className="far fa-image" /> اطلاعات تکمیلی
                  </a>
                </li>
                <li>
                  <a data-bs-toggle="tab" href="#developement-1">
                    <i className="fas fa-cog" /> نظرات کاربران
                  </a>
                </li>
              </ul>
              <div className="tab-content">
                <div id="web-design-1" className="tab-pane active">
                  <p className="m-b10">
                    این محصول با استفاده از مواد اولیه باکیفیت و با دقت بالا
                    تولید شده است. طراحی آن به گونه‌ای است که هم زیبایی و هم
                    کارایی را برای مشتریان به ارمغان می‌آورد و برای استفاده در
                    شرایط مختلف مناسب است.
                  </p>
                  <p>
                    تیم تولید این محصول با بیش از یک دهه تجربه در صنعت، تمامی
                    مراحل طراحی و ساخت را با استانداردهای بین‌المللی دنبال
                    کرده تا رضایت کامل مشتریان را جلب کند. هر محصول پیش از
                    عرضه، تحت آزمایش‌های دقیق کیفی قرار می‌گیرد.
                  </p>
                  <ul className="list-check primary">
                    <li>
                      ساخته شده از بهترین متریال موجود در بازار با تضمین کیفیت
                      و دوام بالا.
                    </li>
                    <li>
                      طراحی مدرن و کاربردی متناسب با نیاز روزمره مشتریان
                      عزیز.
                    </li>
                  </ul>
                </div>
                <div id="graphic-design-1" className="tab-pane">
                  <table className="table table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td>دور کمر</td>
                        <td>{toPersianDigits("26")} سانتی‌متر</td>
                      </tr>
                      <tr>
                        <td>طول</td>
                        <td>{toPersianDigits("40")} سانتی‌متر</td>
                      </tr>
                      <tr>
                        <td>دور سینه</td>
                        <td>{toPersianDigits("33")} اینچ</td>
                      </tr>
                      <tr>
                        <td>جنس پارچه</td>
                        <td>پنبه، ابریشم و الیاف مصنوعی</td>
                      </tr>
                      <tr>
                        <td>گارانتی</td>
                        <td>{toPersianDigits("3")} ماه</td>
                      </tr>
                      <tr>
                        <td>دور سینه</td>
                        <td>{toPersianDigits("33")} اینچ</td>
                      ...
                      <li className="comment">
                        <div className="comment_container">
                          ...
                          <div className="comment-text">
                            ...
                            <p className="meta">
                              <strong className="author">علی محمدی</strong>
                              <span>
                                <i className="far fa-clock" />{" "}
                                {toPersianDigits("17")} اردیبهشت {toPersianDigits("1403")}
                              </span>
                            </p>
                            <div className="description">
                              <p>
                                کیفیت این محصول واقعا فراتر از انتظارم بود. متریال
                                استفاده شده مرغوب و دوخت آن بسیار دقیق است. حتما
                                دوباره از این فروشگاه خرید خواهم کرد.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <li className="comment">
                        <div className="comment_container">
                          ...
                          <div className="comment-text">
                            ...
                            <p className="meta">
                              <strong className="author">مریم احمدی</strong>
                              <span>
                                <i className="far fa-clock" />{" "}
                                {toPersianDigits("2")} خرداد {toPersianDigits("1403")}
                              </span>
                            </p>
                            <div className="description">
                              <p>
                                محصول با بسته‌بندی مناسب و در زمان مقرر به دستم
                                رسید. رنگ‌بندی دقیقا مطابق تصویر بود و از خرید
                                خودم راضی هستم.
                              </p>
                            </div>
                          </div>
                      ...
                      <li className="comment">
                        <div className="comment_container">
                          ...
                          <div className="comment-text">
                            ...
                            <p className="meta">
                              <strong className="author">رضا کریمی</strong>
                              <span>
                                <i className="far fa-clock" />{" "}
                                {toPersianDigits("28")} فروردین {toPersianDigits("1403")}
                              </span>
                            </p>
                            <div className="description">
                              <p>
                                کیفیت ساخت عالی و قیمت مناسب. پشتیبانی فروشگاه
                                هم بسیار خوب و پاسخگو بود. پیشنهاد می‌کنم.
                              </p>
                            </div>
                          </div>
                        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <h5 className="m-b20">محصولات مرتبط</h5>
            <Swiper
              slidesPerView={4}
              spaceBetween={30}
              slidesPerGroup={1}
