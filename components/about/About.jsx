              ...
              <div className="col-lg-6 col-md-12 m-b30 align-self-center video-infobx">
                <div className="content-bx1">
                  <h2 className="m-b15 title">
                    شرکتی فعال در حوزه
                    <br />
                    <span className="text-primary"> خدمات و نگهداری</span>
                  </h2>
                  <p className="m-b30">
                    ما با تکیه بر تجربه چندین ساله در صنعت، خدمات تخصصی
                    نگهداری و پشتیبانی را برای کارخانه‌ها و شرکت‌های صنعتی
                    ارائه می‌دهیم.
                  </p>
                  <Image
                    width={200}
