...
const filters = [
  { filter: "*", text: "همه", isActive: true },
  { filter: ".web", text: "کشاورزی" },
  { filter: ".advertising", text: "شیمیایی" },
  { filter: ".branding", text: "مکانیکی" },
  { filter: ".design", text: "انرژی" },
  { filter: ".photography", text: "کارخانه‌ها" },
];
